        ...
        if usr_cmd == "/start":
            ...
            if(Config.LAZY_MODE == True):
                ...
                reply_markup=InlineKeyboardMarkup(
                    [
                        [
                            InlineKeyboardButton("🍿supp⊕r† gr⊕up", url="https://t.me/+7WBXR3hhX5BiZmM1"),
                            InlineKeyboardButton("🔊ß⊕†s chαηηεl", url="https://t.me/am_films")
                        ],
                        [
                        ...
                        [
                            InlineKeyboardButton("⎝⎝✧✧ ᴡᴀᴛᴄʜ ᴛᴜᴛᴏʀɪᴀʟ ✧✧⎠⎠", url="https://t.me/am_films")
                        ]]))
            else :
                await cmd.reply_photo(photo=lazy_pic,
    ...
    async def main(bot: Client, message: Message):
        ...
        if message.chat.type == enums.ChatType.PRIVATE:
            ...
            if message.from_user.id in Config.BANNED_USERS:
                await message.reply_text("ꜱᴏʀʀʏ, ʏᴏᴜ ᴀʀᴇ ʙᴀɴɴᴇᴅ!\n\nContact [Support Group](https://t.me/+7WBXR3hhX5BiZmM1)",
                                        disable_web_page_preview=True)
                return
                    ...
                    [
                        [
                            InlineKeyboardButton("⚡️SФUЯCΞ CФDΞS ФF ß⊕Γ",
                                                url="https://t.me/+7WBXR3hhX5BiZmM1")
                        ],
                        [
            ...
            if Config.UPDATES_CHANNEL:
                ...
                try:
                    ...
                    if user.status == "kicked":
                        await cmd.message.edit(
                            text="ꜱᴏʀʀʏ ꜱɪʀ, ʏᴏᴜ ᴀʀᴇ ʙᴀɴɴᴇᴅ ᴛᴏ ᴜꜱᴇ ᴍᴇ. ᴄᴏɴᴛᴀᴄᴛ ᴍʏ [Support Group](https://t.me/+7WBXR3hhX5BiZmM1).",
                            disable_web_page_preview=True
                        )
                        return

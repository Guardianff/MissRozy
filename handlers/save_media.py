...
async def save_batch_media_in_channel(bot: Client, editable: Message, message_ids: list):
    try:
        ...
        share_link = f"https://t.me/{Config.BOT_USERNAME}?start=GUARDIANff_{str_to_b64(str(SaveMessage.id))}"
        await editable.edit(
            ...
            reply_markup=InlineKeyboardMarkup(
                [[InlineKeyboardButton("⚡️ Open Link ⚡️", url=share_link)],
                 [InlineKeyboardButton("🔊ß⊕ts Channel", url="https://t.me/am_films"),
                  InlineKeyboardButton("🍿supp⊕rt gr⊕up", url="https://t.me/+7WBXR3hhX5BiZmM1")]]
            ),
            disable_web_page_preview=True
        )
        await bot.send_message(
        ...
        if(Config.LAZY_MODE == True):
            ...
            caption_z = f"{file_name}\n\n༺ᴊᴏɪɴ @{lazypost_channel_username} ༻\n\n🦋・‥☆𝘼𝘿𝙈𝙞𝙉 𝙨𝙪𝙥𝙥𝙤𝙧𝙩☆‥・🦋\n╰┈➤・☆ @{lazypost_ch_admin_usrnm} \n\n+> ᴛʜᴀɴᴋ ʏᴏᴜ <a href='https://telegram.me/GUARDIANff'>⎝⎝✧𝗚𝗨𝗔𝗥𝗗𝗜𝗔𝗡𝗳𝗳✧⎠⎠</a>"
            caption_za = f"{file_name}\n\n༺ᴊᴏɪɴ @{lazypost_channel_username} ༻\n\n+> ᴛʜᴀɴᴋ ʏᴏᴜ <a href='https://telegram.me/am_films'>⎝⎝✧𝗔𝗠_𝗙𝗜𝗟𝗠𝗦✧⎠⎠</a>"
            caption_zab = f"{file_name}\n\n🦋・‥☆𝘼𝘿𝙈𝙞𝙉 𝙨𝙪𝙥𝙥𝙤𝙧𝙩☆‥・🦋\n╰┈➤・☆ @{lazypost_ch_admin_usrnm} \n\n+> ᴛʜᴀɴᴋ ʏᴏᴜ <a href='https://telegram.me/GUARDIANff'>⎝⎝✧𝗚𝗨𝗔𝗥𝗗𝗜𝗔𝗡𝗳𝗳✧⎠⎠</a>"
            caption_zabi = f"{file_name}\n\n+> ᴛʜᴀɴᴋ ʏᴏᴜ <a href='https://telegram.me/+7WBXR3hhX5BiZmM1'>⎝⎝✧𝗔𝗠_𝗙𝗜𝗟𝗠𝗦✧⎠⎠</a>"
            lazy_dev = f"+> ᴛʜᴀɴᴋ ʏᴏᴜ <a href='https://telegram.me/GUARDIANff'>⎝⎝✧𝗚𝗨𝗔𝗥𝗗𝗜𝗔𝗡𝗳𝗳✧⎠⎠</a>"
